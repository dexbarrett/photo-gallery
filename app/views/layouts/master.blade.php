...
<body>
        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="{{URL::route('album.create')}}">Create New Album</a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </div>
    <div class="container" style="text-align: center;">
        <div class="span4" style="display: inline-block; margin-top:100px;">
            ...
            <form name="createnewalbum" method="POST" action="{{URL::route('album.store')}}" enctype="multipart/form-data">
                <fieldset>
